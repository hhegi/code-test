...
set CLASSPATH=%APP_HOME%\lib\code-test-1.0.0.jar


@rem Execute code-test
"%JAVA_EXE%" %DEFAULT_JVM_OPTS% %JAVA_OPTS% %CODE_TEST_OPTS%  -classpath "%CLASSPATH%" com.codetest.Main %*
...
if not ""=="%CODE_TEST_EXIT_CONSOLE%" exit %EXIT_CODE%
exit /b %EXIT_CODE%
